(() => {
	...
	function setCanvasImages() {
		...
		let imgElem2;
		imgElem2 = new Image();
		imgElem2.src = `./images/profileTest.jpg`;
		...
		for (let i = 0; i < sceneInfo[2].values.videoImageCount; i++) {
			imgElem3 = new Image();
			imgElem3.src = `./video/002/IMG_${7027 + i}.JPG`;
			sceneInfo[2].objs.videoImages.push(imgElem3);
		}

		let imgElem4;
		for (let i = 0; i < sceneInfo[3].objs.imagesPath.length; i++) {
			imgElem4 = new Image();
			imgElem4.src = sceneInfo[3].objs.imagesPath[i];
			sceneInfo[3].objs.images.push(imgElem4);
		}
	}
